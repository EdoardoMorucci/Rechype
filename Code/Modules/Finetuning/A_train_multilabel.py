...
def train_step(
    ...
    for X, y in tqdm(dataloader):
        ...
        batch_loss = loss_fn(probabilities, y)
    ...
    train_f1 = f1_score(ground_truths, predictions, average="samples")
...
def valid_step(
    ...
    print(f1_score(ground_truths, predictions, average=None))

    # Compute the f1 score for the training step
    valid_f1 = f1_score(ground_truths, predictions, average="samples")
