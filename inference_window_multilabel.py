...
from Code.Modules.Inference.B_run_inference_window_multilabel import infer
from Code.Dataset.WindowDataset import AudioDataset
...
def main(
    ...
    dataset = AudioDataset(dataset_path, window_length=window_length)
